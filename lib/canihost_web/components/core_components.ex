defmodule CanihostWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CanihostWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CanihostWeb.Gettext, "errors", msg, opts)
    end
  end
